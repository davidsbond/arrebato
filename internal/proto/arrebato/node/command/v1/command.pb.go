...
// Package arrebato.node.command.v1 provides commands written to the raft log regarding cluster membership.
...
// The AddNode message is a command indicating that a new node has joined the cluster.
type AddNode struct {
...
// The RemoveNode message is a command indicating that an existing node has left the cluster.
...
func (x *RemoveNode) GetNode() *v1.Node {
	if x != nil {
		return x.Node
	}
	return nil
...
var file_arrebato_node_command_v1_command_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x22, 0x38, 0x0a, 0x0a, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65,
	0x4e, 0x6f, 0x64, 0x65, 0x12, 0x2a, 0x0a, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x16, 0x2e, 0x61, 0x72, 0x72, 0x65, 0x62, 0x61, 0x74, 0x6f, 0x2e, 0x6e, 0x6f,
	...
	0x6f, 0x2f, 0x61, 0x72, 0x72, 0x65, 0x62, 0x61, 0x74, 0x6f, 0x2f, 0x6e, 0x6f, 0x64, 0x65, 0x2f,
	0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x2f, 0x76, 0x31, 0x3b, 0x6e, 0x6f, 0x64, 0x65, 0x63,
...
var file_arrebato_node_command_v1_command_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_arrebato_node_command_v1_command_proto_depIdxs = []int32{
	2, // 0: arrebato.node.command.v1.AddNode.node:type_name -> arrebato.node.v1.Node
	2, // 1: arrebato.node.command.v1.RemoveNode.node:type_name -> arrebato.node.v1.Node
