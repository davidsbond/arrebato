...
// The AllocateTopic message is a command indicating that a topic has been allocated to a specific node.
type AllocateTopic struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AllocateTopic) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AllocateTopic) ProtoMessage() {}

func (x *AllocateTopic) ProtoReflect() protoreflect.Message {
	mi := &file_arrebato_node_command_v1_command_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AllocateTopic.ProtoReflect.Descriptor instead.
func (*AllocateTopic) Descriptor() ([]byte, []int) {
	return file_arrebato_node_command_v1_command_proto_rawDescGZIP(), []int{2}
}

func (x *AllocateTopic) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AllocateTopic) GetTopic() string {
	if x != nil {
		return x.Topic
	}
	return ""
...
var file_arrebato_node_command_v1_command_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x39, 0x0a, 0x0d, 0x41, 0x6c, 0x6c, 0x6f,
	0x63, 0x61, 0x74, 0x65, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a,
	0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f,
	0x70, 0x69, 0x63, 0x42, 0x50, 0x5a, 0x4e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_arrebato_node_command_v1_command_proto_goTypes = []interface{}{
	...
	(*AllocateTopic)(nil), // 2: arrebato.node.command.v1.AllocateTopic
